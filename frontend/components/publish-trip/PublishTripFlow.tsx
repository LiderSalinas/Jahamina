...
export function PublishTripFlow({ demo = false }: { demo?: boolean }) {
  ...
  return <main className="publish-flow">
    <header className="publish-heading"><Link className="publish-back-link" href="/viajes">← Explorar viajes</Link><p className="eyebrow">Compartí el camino</p><h1>Publicar viaje</h1><p>Definí tu recorrido, completá los detalles y publicá tu viaje en pocos pasos.</p></header>
