...
export function ChatPreview({ reservationId, reservationState }: { reservationId: number; reservationState: string }) {
  ...
  return <>
    <div className="chat-preview-body">
      {conversation && <div className="chat-preview-person"><span aria-hidden>{conversation.participante.slice(0, 1).toUpperCase()}</span><div><b>{conversation.participante}</b><small>Conversación disponible</small></div></div>}
